...
export const allProjects: Project[] = [
  {
    id: "redcon",
    title: "REDCON — AI Red Team Platform",
    type: "AI Security + Full-Stack",
    shortDesc: "AI-driven scope-enforced red team / pentest orchestration platform.",
    description: "REDCON is an AI-driven, scope-enforced red team / pentest orchestration platform. You give it an authorized target (an engagement scope), and its AI assistant plans and runs reconnaissance, scanning, and validation actions against that target — automatically, but never outside your authorization. Features an autonomous investigation loop (Observe→Analyze→Plan→Select) powered by local LLMs via Ollama.",
    features: [
      "Scope Engine: engagements, targets, exclusions, validation",
      "Tool Registry: capability catalog for nmap, nuclei, hydra, etc.",
      "Sandbox Executor: isolated Docker runs with egress-restricted networking",
      "Approval Gate: human approval for active_scan / exploit actions",
      "AI Assistant Orchestrator: LLM-driven investigation loop (Observe→Analyze→Plan→Select)",
      "Docker-based tool containers with per-engagement isolated networks",
      "REST API backend (FastAPI) + React/Vite frontend"
    ],
  ...
  },
  {
    ...
    type: "AI-Assisted QA Automation + Full-Stack",
    shortDesc: "AI-assisted end-to-end QA automation platform turning documents, recordings, and AI agents into executable test cases with Jira integration.",
    description: "SQAT is an AI-assisted end-to-end QA automation platform. It turns your project documents, live application recordings, and AI agents into reviewable test cases, executable Playwright scripts, classified results, and Jira defects — with a human approval gate at every critical step. Built for enterprise insurance and financial services applications.",
    features: [
      "AI-generated High-Level Scenarios from documents",
      "Application recording for accurate test automation",
      "Human-in-the-loop test case review and approval",
      "Parallel Playwright script execution",
      "Intelligent result classification and auto-repair",
      "Automatic Jira defect creation",
      "X-Ray CSV export and execution reporting"
    ],
    ...
    pageUrl: "/projects/sqat-framework"
  }
];