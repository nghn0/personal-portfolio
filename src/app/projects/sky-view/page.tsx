      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <h1 className="text-4xl md:text-6xl font-bold font-heading mb-6 tracking-tight">
            Sky <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-neutral-400">View</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            <a href="https://github.com/nghn0/Sky_View" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/20 transition-all text-white font-medium hover:shadow-[0_0_15px_rgba(185,195,212,0.15)]">
        ...
        <div className="space-y-16">
          <motion.section initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6 }} className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass-card p-6 bg-black/50">
              <Cloud className="text-[#b9c3d4] mb-4" size={28} />
            ...
            <div className="glass-card p-6 bg-black/50">
              <Database className="text-[#b9c3d4] mb-4" size={28} />
