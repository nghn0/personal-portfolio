...
import { ArrowLeft, Github, Activity, Database, TrendingUp } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-xl text-gray-400 font-body leading-relaxed mb-10">
            An end-to-end analysis of solar sunspot cycles and an LSTM-based forecasting model to predict future Solar Sunspot Numbers (SSN), bridging deep learning with space weather analysis.
          </p>
